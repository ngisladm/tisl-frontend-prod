...
function ExtraAvulsoScreen({user}){
  ...
  return(
    <div style={S.card}>
      ...
      {items.length===0?<div style={S.emptyState}><span style={S.emptyIcon}>⚡</span>Nenhum extra avulso lançado.</div>:(
        <table style={S.table}>
          <thead><tr>
            ...
            <div key={team.teamId} style={{...S.card,marginBottom:16}}>
              ...
              <table style={S.table}>
                <thead><tr>
                  ...
                  <th style={{...S.th,textAlign:"center"}}>Total Sobreaviso (÷2)</th>
                ...
                <tbody>
                  ...
                  <tr style={{background:"#FFF8E1"}}>
                    ...
                    <td style={{...S.td,textAlign:"center",fontWeight:700,color:C.primary}}>{team.totalSobreavisoHHMM} <span style={{fontSize:10,color:C.textLight}}>(÷2)</span></td>
...
const screenTitles={home:"Início",s1:"Cadastros › Perfis",s2:"Cadastros › Usuários",s3:"Cadastros › Empresas",s4:"Cadastros › Equipes",s5:"Movimentações › Controle de Horas",s6:"Relatórios › Relatório de Horas",s7:"Movimentações › Extra Avulso"};
