...
function HomeScreen({user,navigate}){
  ...
  const cards=[
    ...
    {icon:"⏱️",title:"Controle de Sobreaviso/Extra",sub:`${stats.escalas} escala(s)`, action:()=>navigate("s5"),screenId:"s5"},
...
const navConfig=[
  ...
  {id:"movimentacoes",label:"Movimentações",icon:"🔄",children:[
    {id:"s5",label:"Controle de Sobreaviso/Extra",icon:"⏱️"},
  ]},
...
const screenTitles={home:"Início",s1:"Cadastros › Perfis",s2:"Cadastros › Usuários",s3:"Cadastros › Empresas",s4:"Cadastros › Equipes",s5:"Movimentações › Controle de Sobreaviso/Extra",s6:"Relatórios › Relatório de Horas"};
